...
//      setRegisteredOnServer(context, null, 0);
     ...
     */
    public static void setRegisteredOnServer(Context context, boolean flag, String rcId) {
        ...
        setRegisteredOnServer(context, flag, expirationTime, rcId);
    }

    private static void setRegisteredOnServer(Context context, Boolean flag,
            long expirationTime, String rcId) {
        final SharedPreferences prefs = getGCMPreferences(context);
        Editor editor = prefs.edit();
        if (flag != null) {
            editor.putBoolean(PROPERTY_ON_SERVER+rcId, flag);
            log(context, Log.VERBOSE,
     ...
     */
    public static boolean isRegisteredOnServer(Context context,String rcID) {
        final SharedPreferences prefs = getGCMPreferences(context);
        boolean isRegistered = prefs.getBoolean(PROPERTY_ON_SERVER+rcID, false);
