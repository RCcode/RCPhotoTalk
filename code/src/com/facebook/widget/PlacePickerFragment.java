...
public class PlacePickerFragment extends PickerFragment<GraphPlace> {
	 ...
	 * 
	 * @param args
	 *            a Bundle that optionally contains one or more values containing additional configuration information
	 *            for the Fragment.
	 */
	 ...
	 * @param searchText
	 *            the search text
	 * @param forceReloadEventIfSameText
	 *            if true, will reload even if the search text has not changed; if false, identical search text will not
	 *            force a reload
	 */
