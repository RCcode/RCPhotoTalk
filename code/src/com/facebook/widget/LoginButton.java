...
public class LoginButton extends Button {
	 ...
	 * 
	 * @param requestCode
	 *            The requestCode parameter from the forwarded call. When this onActivityResult occurs as part of
	 *            Facebook authorization flow, this value is the activityCode passed to open or authorize.
	 * @param resultCode
	 *            An int containing the resultCode parameter from the forwarded call.
	 * @param data
	 *            The Intent passed as the data parameter from the forwarded call.
