...
public class WebDialog extends Dialog {
	 ...
	 * @param url
	 *            the URL of the Web Dialog to display; no validation is done on this URL, but it should be a valid URL
	...
	public static class Builder extends BuilderBase<Builder> {
		 ...
		 * @param session
		 *            the Session representing an authenticating user to use for showing the dialog; must not be null,
		 *            and must be opened.
		 * @param action
		 *            the portion of the dialog URL following www.facebook.com/dialog/. See
	...
	public static class FeedDialogBuilder extends BuilderBase<FeedDialogBuilder> {
		 ...
		 *            the Context within which the dialog will be shown.
		 * @param parameters
		 *            a Bundle containing parameters to pass as part of the dialog URL. No validation is done on these
		 *            parameters; it is the caller's responsibility to ensure they are valid.
		 * @param session
		 *            the Session representing an authenticating user to use for showing the dialog; must not be null,
		 *            and must be opened.
		 */
