...
import com.rcplatform.videotalk.task.ContactUploadTask;
import com.rcplatform.videotalk.task.GetBindPhoneTask;
import com.rcplatform.videotalk.task.ThirdPartInfoUploadTask;
import com.rcplatform.videotalk.task.ContactUploadTask.Status;
import com.rcplatform.videotalk.task.GetBindPhoneTask.OnBindSuccessListener;
...
public class PTBackgroundService extends Service {
	...
	private void sendSMSStateToService(String number, long time) {
		com.rcplatform.videotalk.request.Request request = new com.rcplatform.videotalk.request.Request(getBaseContext(),
	...
	private void updateVKInfo() {
		new Thread() {
			...
			public void run() {
				...
				if (vkAccount != null) {
					try {
						Api api = new Api((String) vkAccount[0], com.rcplatform.videotalk.utils.Constants.VK_API_ID);
