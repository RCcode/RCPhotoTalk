...
//	private static final String BASE_URL = "http://192.168.0.116/";
	...
	public static final String CLEAN_HISTORY_URL = BASE_URL_FOR_PHOTOTALK + "notice/clearAllNotice.do";

	public static final String DELETE_FRIEND_URL = THIRD_URL + "delUserFriend.do";
	...
	public static final String HOME_USER_NOTICE = BASE_URL_FOR_PHOTOTALK + "notice/mainUserNoticeList.do";

	public static final String HOME_USER_NOTICE_CHANGE = BASE_URL_FOR_PHOTOTALK + "notice/downLoadOrLookNotice.do";

	public static final String HOME_USER_NOTICE_ADD_FRIEND = USER_URL + "addFriendFromMain.do";

	public static final String HOME_USER_NOTICE_DELETE = BASE_URL_FOR_PHOTOTALK + "notice/deleteTheNotice.do";

	public static final String HOME_USER_NOTICE_DELETE_ALL = BASE_URL_FOR_PHOTOTALK + "notice/clearAllNotice.do";
