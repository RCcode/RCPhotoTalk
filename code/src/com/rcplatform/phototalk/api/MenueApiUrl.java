...
//	private static final String BASE_URL = "http://103.247.169.150:8083/";
	...
	public static final String HOME_USER_NOTICE_CHANGE = NOTICE_URL
	...
	public static final String HOME_USER_NOTICE_DELETE_ALL = NOTICE_URL
			+ "clearAllNotice.do";
	...
	public static final String FACEBOOK_RECOMMENDS_URL = USER_URL
			+ "queryThirdUsers.do";
	...
	// 2.3 用户登录
	public static final String LOGIN_URL = BASE_URL_FOR_USER
			+ "login/userLogin.do";

	// 2.1 用户注册
	public static final String SIGNUP_URL = BASE_URL_FOR_USER
			+ "login/regist.do";
	public static final String CHECK_USER_URL = BASE_URL_FOR_USER
			+ "login/hasUserInfo.do";
	// 2.25 清空所有记录

	// 2.22 删除好友（单方向删除）

	// 2.4 忘记密码
	public static final String FORGET_PASSWORD_URL = BASE_URL_FOR_USER
			+ "user/getUserPass.do";
	...
	// 2.26 验证登录密码
	public static final String CHECK_LOGIN_PASSWORD_URL = BASE_URL_FOR_USER
			+ "login/checkPwdForUpdate.do";

	// 2.27 修改登录密码
	public static final String UPDATE_LOGIN_PASSWORD_URL = BASE_URL_FOR_USER
			+ "login/updUserPass.do";

	// 2.28 存储tacotyId

	public static final String CHECK_USER_PHONEBIND_URL = BASE_URL_FOR_USER
			+ "user/checkPhone.do";
	public static final String UPDATE_PHONE_BIND_STATE_URL = COMM_URL
			+ "phoneLog.do";
