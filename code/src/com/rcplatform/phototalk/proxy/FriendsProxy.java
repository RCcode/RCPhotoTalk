...
public class FriendsProxy {
	...
	// 田镇源 上传zip方法
	public static void postZip(Context context, File file, RCPlatformResponseHandler responseHandler, String head_url, String time, String nick, String desc, String timeLimit, String user_appary) {
	...
	public static void addFriendFromInformation(Context context, RCPlatformResponseHandler responseHandler, Information info) {
		RCPlatformAsyncHttpClient client = new RCPlatformAsyncHttpClient(RequestAction.JSON);
		PhotoTalkParams.buildBasicParams(context, client);
		client.putRequestParam(PhotoTalkParams.AddFriendFromInformation.PARAM_KEY_INFORMATION_ID, info.getRecordId());
		client.putRequestParam(PhotoTalkParams.AddFriendFromInformation.PARAM_KEY_INFORMATION_TYPE, info.getType() + "");
		client.putRequestParam(PhotoTalkParams.AddFriendFromInformation.PARAM_KEY_INFORMATION_STATE, info.getStatu() + "");
		client.putRequestParam(PhotoTalkParams.AddFriendFromInformation.PARAM_KEY_FRIEND_SUID, info.getSender().getSuid());
