...
public class EditableViewGroup extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.i("Futao", "specSize_Widht = " + specSize_Widht + " specSize_Heigth = " + specSize_Heigth);
    ...
    public void addEditeTextView(LinearLayout view) {
        ...
        editTextView.layout(0, specSize_Heigth / 2, editTextView.getMeasuredWidth(), specSize_Heigth / 2 + editTextView.getMeasuredHeight());
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isMove) {
                    editTextView.layout(0, y, getChildAt(1).getMeasuredWidth(), y + getChildAt(1).getMeasuredHeight());
                }
                break;
